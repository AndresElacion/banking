<div class="flex flex-col-5 pl-4">
    <div class="pr-4">
        <!-- Modal toggle -->
        <button data-modal-target="default-modal" data-modal-toggle="default-modal" class="block text-black bg-slate-50 hover:bg-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-2xl shadow-2xl text-md px-5 py-8" type="button">
            <i class="fa-solid fa-money-bill-transfer fa-xl pb-10 -ml-8 text-start"></i> 
            <p>Transfer</p>
        </button>
